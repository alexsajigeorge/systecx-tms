  ...
  return (
    <li className="relative">
      <Link
        ...
        href="#"
        className="relative flex h-8.5 w-8.5 hover:text-primary"
      >
        <span
      ...
      >
        ...
        <ul className="flex h-auto flex-col overflow-y-auto">
          <li>
            <Link
              className="flex flex-col gap-2.5 border-t border-stroke p-4 hover:bg-gray-2 dark:border-strokedark dark:hover:bg-meta-4"
              href="#"
            >
              <p className="text-sm">
